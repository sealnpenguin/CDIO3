...
public class Language {
    ...
    String[] dk = {"Indtast antallet af spillere fra 2-4", "Prøv igen i intervallet 2-4", "Indtast navn til spiller ", " vælg en farve til din bil",
            "RØD", "SORT", "BLÅ", "MAGENTA", "ROSE", "CYAN", "GUL", "HVID", " har 0M og taber spillet", "Og vinderen er ... "," tryk på knappen for at kaste terningen!","Kast", "Spil igen?", "Ja!", "Nej!"};
    ...
    String[] eng = {"Enter the number of players ranging from 2-4", "Please try again in the range of 2-4", "Enter name for player ", " choose a color for your car",
            "RED", "BLACK", "BLUE","MAGENTA","PINK","CYAN","YELLOW","WHITE", " has reached 0 and lost the game", "And the winner is...  ", " press button to roll the die!", "Roll", "Play Again?", "Yes!", "No!"};
